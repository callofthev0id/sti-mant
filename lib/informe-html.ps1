...
.kpi{background:#f4f7f5;border:1px solid #e0e6e2;border-radius:8px;padding:10px 16px;text-align:center;flex:1}
.kpi .n{font-family:'DM Mono',monospace;font-size:24px;color:#053028}
.kpi .l{font-size:10px;color:#717171;text-transform:uppercase;letter-spacing:.05em}
.atender{margin:0 18px 14px;background:rgba(224,120,32,.06);border:1px solid rgba(224,120,32,.35);border-left:4px solid #e07820;border-radius:0 4px 4px 0;padding:8px 14px}
.atender h4{margin:0 0 5px;color:#e07820;font-size:12px;text-transform:uppercase;letter-spacing:.05em}
.atender li{font-size:12px;margin:2px 0}
.sec-t{font-size:13px;font-weight:700;text-transform:uppercase;letter-spacing:.08em;color:#053028;margin:14px 18px 6px;border-left:3px solid #43C961;padding-left:8px}
...
.mtx tr.grp th{background:#2B9C70;color:#fff;font-size:11px;text-transform:uppercase}
.mtx tr.grp th.eqh{background:#053028}
.mtx tr.chk th{background:#053028;color:#fff;font-weight:500;font-size:10px;height:118px;vertical-align:bottom;padding-bottom:6px}
...
.mtx td.c{text-align:center;font-weight:700;font-size:15px;color:#053028;width:26px}
...
<div class='banner'>$logoTag<h1>STI MANTENIMIENTO · Informe de Mantenimiento - $titulo</h1></div>
